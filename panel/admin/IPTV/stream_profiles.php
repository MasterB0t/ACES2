        ...
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1><?=$PageName;?></h1>
                        <ol class="breadcrumb float-sm-left pt-2">
                            <li class="breadcrumb-item active"><?=$PageName;?></li>
                        </ol>
                    </div>
                    <div class="col-sm-6">
                        <a href="form/formStreamProfile.php"
                           class="btn btn-sm btn-primary float-right mr-1" >Add </a>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
        </section>
...
<script>
    ...
    $(document).ready(function () {
        ...
        table = $("#table").DataTable({
            ...
            "searching": true,
            "ajax": {
                url: "/admin/IPTV/tables/gTableStreamProfiles.php"
            },
            "stateSaveCallback": function (settings, data) {
                window.localStorage.setItem("dataTableStreamProfiles", JSON.stringify(data));
            },
            "stateLoadCallback": function (settings) {
                if (!window.localStorage.getItem("dataTableStreamProfiles")) FIRST_TIME_LOADING_PAGE = 1;
                return JSON.parse(window.localStorage.getItem("dataTableStreamProfiles"));
            },
