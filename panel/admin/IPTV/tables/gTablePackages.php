...
$r=$DB->query("SELECT b.id FROM iptv_bouquet_packages b
 ");
...
if($r->num_rows < 1)  $json['data'] = array();
    ...
    $links = "<a href='form/formBouquetPackage.php?id={$row['id']}' title='Edit Package' > 
            <i style='margin:5px;' class='fa fa-edit fa-lg'></i> </a>";
    $links .= "<a href='#!' title='Remove Package' onClick=\"removePackage('{$row['id']}');\"> 
