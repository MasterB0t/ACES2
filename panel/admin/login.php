...
if($_SESSION['admin_expiration'] > time() )
    Redirect('/admin/profile.php');

$ref = str_replace(HOST."/admin/", '', $_SERVER['HTTP_REFERER']);
if($_SESSION['admin_id']) {
    Redirect('/admin/lock.php?ref='.$ref);
}
    ...
    <div  class="card">
        <div class="card-body login-card-body">
            ...
            <form method="post" id="login">
                ...
                <input type="hidden" name="token" value="<?= \ACES2\Armor\Armor::createToken('admin_login',
                    60 * 10 );?>" />
        ...
        $("#login").submit(function (e) {
            ...
            $.ajax({
                ...
                success: function (resp) {
                    ...
                    //adminGetSettings(function(){ window.location = go_to; })
