<?php
    ...
    $db = new \ACES2\DB;
    $r_cats = $db->query("SELECT id,name FROM iptv_stream_categories ORDER BY name");
...
<head>
    ...
    <title><?= SITENAME; ?>| Movies & Series </title>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <select class="form-group select2" name="category" >
                                                    <option value="">All</option>
...
<script>
    ...
    TABLEURL = "/user/IPTV/tables/gTableVideos.php";
    var DataName = 'user.iptv.videos';
