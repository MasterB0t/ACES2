...
if(count($resellers)>0) {
    ...
    $db = new \ACES2\DB();
    $r = $db->query("SELECT id,username FROM users WHERE id in ($sql)");
            ...
            <div class="container-fluid">
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        ...
                        <a href="form/formReseller.php" class="btn btn-sm btn-primary float-right ml-2">Add Reseller</a>
...
<script>
    ...
    TABLEURL = "/user/IPTV/tables/gTableResellers.php";
